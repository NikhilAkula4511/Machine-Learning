...
list_languages = ['English','Data Science','Deep Learning',
                  'Mathematics','Machine learning']
language = st.selectbox("Select an AI Tutor ", list_languages)

st.title(f"🤖 {language}")

f = open(r'C:\Users\Hello\Desktop\Gen_AI\TASK_2\data\.gemini_key.txt')
api_key = f.read()
...
if "messages" not in st.session_state.keys() or st.session_state.language != language:
    ...
    st.title(f"📢:rainbow[How may I help you with {language} today?]")
